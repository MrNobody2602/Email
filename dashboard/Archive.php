...
// Fetch emails with status = 'archive'
$email_query = "SELECT * FROM emails WHERE recipient_email = ? AND status = 'archive' ORDER BY created_at DESC";
...
<div class="container">
    <div class="table-wrapper">
        <div class="table-responsive">
            <table class="table table-striped table-hover" id="archive-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php 
                        if ($email_result->num_rows > 0) {
                            while ($email_row = $email_result->fetch_assoc()) {
                                ...
                                echo "<tr class='view-emailDetails $glowClass' data-email='$emailData'>
                                        ...
                                        <td class='action-icons'>
                                            ...
                                            <button class='icon icon-button delete-button' onclick='changeStatus(" . $email_row['id'] . ", \"trash\")' title='delete'>
                            ...
                            echo "<tr><td colspan='6'>Your archive is empty.</td></tr>";
                        }
                        $email_stmt->close();
                    ?>
                </tbody>
